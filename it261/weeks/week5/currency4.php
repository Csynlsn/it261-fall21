...
<!--add something inside input (value attribute: value=""  value=php snippit) to make sticky-->
...
<!--this is our radio button choice. can click on only one at a time-->
...
//if posts name, email, currency, ammount are empty
//we will call out a specific echo
...
//if post bank is NULL (no " "), please select your bank
...
<div class="box">
<h2>Hello, '.$name.'</h2>
<p>You have $'.$friendly_total.' American Dollars, 
and it will be deposited in <b>'.$bank.' bank</b> and we will email you at <b>'.$email.'</b> in the next 24 hours.</p>
</div>';

if($friendly_total >= 1000) {
    echo '<h2><b>I have '.$friendly_total.' American dollars and I am really happy!</b></h2>
    <div class="video">
    <iframe width="560" height="315"
    src="https://www.youtube.com/embed/GO22Z0T3qPE?start=14&autoplay=1" 
    title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; 
    clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>';
} elseif($friendly_total <= 999) {
    echo '<h2><b>I only have '.$friendly_total.' American dollars and I am very sad.</b></h2>
    <div class="video">
    <iframe width="560" height="315" 
    src="https://www.youtube.com/embed/fJ9rUzIMcZQ?start=204&autoplay=1" 
    title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; 
    clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>';
}
