...
//converting foreign money to USD: what is the logic?
//our $ammount * $currency will give us the dollars
$dollars = $amount * $currency;
$friendly_dollars = floor($dollars);
echo '
<div class="box">
<h2>Hello, '.$name.'</h2>
<p>You now have $'.$friendly_dollars.' American dollars! We will send your confirmation email to <b>'.$email.'</b> !</p>
