<?php
// our first emailable form yay
// unlike our travel calc, our php will go up here we can not echo above the doctype
...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if(empty($_POST['privacy'])) {
        $privacy_Err = 'You must agree to our terms';
    } else {
...
// logic: if post wines is NOT empty, we need to grab the wines and display them
...
<!-- to make sticky: add value="" inside input tag. inside value=" " put PHP -->
